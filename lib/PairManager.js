...
PairManager.prototype.pair = function(mobileId, desktopId) {
  for (var id of this.desktops.keys()) {
    // Bad fucking idea lol, what are the chances -shrug-
    if (id.startsWith(desktopId) && desktopId.length >= 6) {
      desktopId = id;
    }
  }
